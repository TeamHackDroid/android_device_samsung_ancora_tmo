...
void CameraHAL_FixupParams(android::CameraParameters &camParams, priv_camera_device_t* dev)
{
    ...
    const char *video_sizes = "1280x720,800x480,720x480,640x480,352x288,320x240,176x144";
    ...
    camParams.set(android::CameraParameters::KEY_SUPPORTED_VIDEO_SIZES,
                  video_sizes);
    int videosize = camParams.getInt(CameraParameters::KEY_PREVIEW_SIZE);
    if (videosize == "640x480"){
        camParams.set(android::CameraParameters::KEY_VIDEO_SIZE, "640x480");  
    }
    if (videosize == "320x240"){
        camParams.set(android::CameraParameters::KEY_VIDEO_SIZE, "320x240");  
    }
    if (videosize == "176x144"){
        camParams.set(android::CameraParameters::KEY_VIDEO_SIZE, "176x144");  
    }
